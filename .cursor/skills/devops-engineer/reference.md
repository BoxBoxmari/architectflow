# DevOps Engineer – Reference (Full Examples)

Full CI/CD, Terraform, Helm, monitoring, security, and deployment examples. Use with the devops-engineer skill.
...
## 2. Terraform – main.tf (VPC, EKS, RDS, Redis, ALB)
...
module "eks" {
  ...
  eks_managed_node_groups = {
    main = {
      ...
      k8s_labels = { Environment = var.environment; NodeGroup = "main" }
...
variable "project_name" { description = "Name of the project"; type = string }
variable "environment" { description = "Environment (staging/production)"; type = string }
...
output "database_endpoint" { description = "RDS instance endpoint"; value = aws_db_instance.main.endpoint; sensitive = true }
output "redis_endpoint" { description = "ElastiCache endpoint"; value = aws_elasticache_replication_group.main.configuration_endpoint_address }
```

---

## 3. Helm – deployment.yaml and HPA
